        ...
        <section className="relative h-screen w-full mx-auto">
            <div className='absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 pt-14'>
                ...
                <div className='w-4/5'>
                    ...
                    Iam a fullstack web developer especially in build and designing web. Recently I'm focused on building responsive web applications with mongodb database and prisma.<br className='sm:block hidden' />
