...
const About = () => {
  return (
    <div id='about' className="relative w-full h-screen px-2 xl:px-8 md:px-6 sm:px-4">
      ...
      <motion.p variants={fadeIn('down',0.2)} initial="hidden" animate="show" exit="hidden" className='mt-4 text-secondary text-[17px] max-w-3xl leading-[30px] text-justify w' >
