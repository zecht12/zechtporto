...
const ExperienceCard = ({ experience }:any) => {
  return (
    <VerticalTimelineElement className="text" contentStyle={{ background: "#1d1836", color: "#fff", }} contentArrowStyle={{ borderRight: "7px solid  #232631" }} date={experience.date} iconStyle={{ background: experience.iconBg }} icon={
