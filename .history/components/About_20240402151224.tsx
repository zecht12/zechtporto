  ...
  return (
    <div id='about' className="relative w-full md:h-screen h-auto px-2 xl:px-8 md:px-6 sm:px-4">
      ...
      <motion.p variants={fadeIn('down',0.2)} initial="hidden" animate="show" exit="hidden" className='mt-4 text-secondary text-[17px] max-w-3xl leading-[30px] text-justify' >
        I'm a skilled software developer with experience in TypeScript and JavaScript, and expertise in frameworks like Nextjs, React, and Three.js. I'm a 3. I'm a quick learner and collaborate closely with clients to create efficient, scalable, and user-friendly solutions that solve real-world problems. Let's work together to bring your ideas to life!
      </motion.p>
