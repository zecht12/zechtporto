        ...
        <section className="relative h-screen w-full mx-auto">
            <div className='absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 pt-14'>
                ...
                <div className='w-3/5'>
                    ...
                    <p className='text-[#dfd9ff] font-medium lg:text-[20px] sm:text-[16px] xs:text-[10px] text-[6px] lg:leading-[40px] pt-2 text-justify'>
                        My real name is Gilang Prima Ertansyah. I'm a fullstack web developer especially in build and designing web.
                    </p>
                    <p className='text-[#dfd9ff] font-medium lg:text-[20px] sm:text-[16px] xs:text-[10px] text-[6px] lg:leading-[40px] mt-2 text-justify'>
