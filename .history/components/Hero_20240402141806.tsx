...
const Hero = () => {
    return (
        <section className={`relative w-full h-[150vh] mx-auto`}>
            <div className={`absolute inset-0 top-[120px]  max-w-7xl mx-auto p-paddingX flex flex-row items-start gap-5 md:pt-0 pt-14`} >
            ...
            <div className="md:pt-14 pt-5 w-full h-full">
                <ComputersCanvas />
            </div>
        </section>
    );
