...
const Works = () => {
  return (
    <div id='work' className="px-6">
      ...
      <motion.div initial="offscreen" whileInView="onscreen" viewport={{ once: true, amount: 0.8 }} variants={cardVariantsY1} className='mt-20 flex flex-wrap items-center justify-center gap-7'>
